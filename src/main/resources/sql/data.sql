...
VALUES ('아메리카노 1', 4000,
       ...
       ('바닐라 라떼 1', 5000,
        'https://images.unsplash.com/photo-1572442388855-4341a444d3b8?auto=format&fit=crop&w=800&q=80'),
       ('카라멜 마끼아또 1', 5500,
        'https://images.unsplash.com/photo-1542990253-a781447c1651?auto=format&fit=crop&w=800&q=80'),
       ('에스프레소 1', 3500,
        'https://images.unsplash.com/photo-1501339847703-ac7b5788204b?auto=format&fit=crop&w=800&q=80'),
